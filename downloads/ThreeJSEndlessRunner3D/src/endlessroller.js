...
// 创建金币代替树木
function createTree(){
	console.log("💰 Creating coin sprite from image");
	
	// 加载金币图片纹理
	var textureLoader = new THREE.TextureLoader();
	var coinTexture = textureLoader.load('assets/coin.png');
	
	// 创建精灵材质
	var coinMaterial = new THREE.SpriteMaterial({ 
		map: coinTexture,
		color: 0xffffff,
		transparent: true
	});
	...
	// 创建精灵
	var coin = new THREE.Sprite(coinMaterial);
